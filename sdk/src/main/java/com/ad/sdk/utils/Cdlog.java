...
import static com.ad.sdk.utils.CdlogListener.LOG_LEVEL;
...
public class Cdlog {
	...
	private static boolean cdlogged = false;
	...
	private static Map<String, String> lastRequestheader;
	...
	synchronized public static void setLastRequestheader(Map LastRequestheader){
		Cdlog.lastRequestheader = LastRequestheader;
	}

	synchronized public static Map getLastRequestheader(){
	...
	private static final ArrayList<CdlogListener> alisteners = new ArrayList<>();
